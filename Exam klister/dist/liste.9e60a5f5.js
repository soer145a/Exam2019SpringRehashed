...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"liste.js":[function(require,module,exports) {
...
function constructObj(data) {
  var objTemplate = document.querySelector("#myTemplate");
  var destination = document.querySelector("#container");
  data.forEach(function (obj, index) {
    var klon = objTemplate.cloneNode(true).content;
    ...
    deleteButton.setAttribute("id", "deleteIndex".concat(index));
    var deleteButtonText = document.createElement("p");
...
function deleteTarget(obj) {
  console.log(obj);
  fetch("https://examusers-4b00.restdb.io/rest/databaseuser/".concat(obj._id), {
    method: "delete",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","liste.js"], null)
//# sourceMappingURL=/liste.9e60a5f5.js.map